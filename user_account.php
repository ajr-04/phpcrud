  ...
  <div class="row">
    <div class="col-md-12">
      <div class="profile-info">
        ...
        <div class="info-body">
          <p><strong>First Name:</strong> <?php echo $data['user_fn']?></p>
          <p><strong>Last Name:</strong> <?php echo $data['user_ln']?></p>
          <p><strong>Birthday:</strong> <?php echo $data['user_birth']?></p>
        </div>
      </div>
    </div>
    </div>
