...
ini_set('display_errors', 1);
    ...
    function viewdata($id){
        try{
        $con = $this->opencon();
        $query= $con->prepare("SELECT users.user_id, users.user_fn, users.user_ln, users.user_birth, users.user_sex, users.user_profile_picture, users.user_name, users.user_pass, 
