...
try {
    ...
    $query = $connection->prepare("SELECT users.user_id, users.user_fn, users.user_ln, users.user_birth, users.user_sex, users.user_name, users.user_profile_picture, CONCAT(user_address.user_city, ', ', user_address.user_province) AS users_address FROM users INNER JOIN user_address ON users.user_id = user_address.user_id LIMIT :offset, :recordsPerPage");
